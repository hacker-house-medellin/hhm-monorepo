...
Secrets for `hacker-house-medellin/hhm-monorepo` are **committed, encrypted**, with [sops] + [age],
...
```sh
just env-docker-run dev ghcr.io/hacker-house-medellin/hhm-monorepo:dev
